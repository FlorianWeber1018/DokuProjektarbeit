...
\chapter{Software}
	...
	\section{Arduino}
		...
		Letzteres ist notwendig um das Timing des Controllers exakt zu steuern. Zu Beginn des Programms wird die ganze Peripherie konfiguriert und die globalen Variablen mit ihren default Werten geladen.
		Anschließend werden die Interrupts global freigegeben. Ab hier ist die Steuerung funktionsfähig.\\
...
%HIER WEITER
			...
			Dies wurde realisiert, imdem man sich den Zustand des letzten Pin Change Interrupt gemerkt hat und diesen mit dem aktuellen Zustand, des jeweiligen Ports, durch ein Exklusivoder verknüpft.
			Außerdem gibt es die zwei Möglichkeiten:
				...
				\end{itemize}
			Hat ein \emph{High-Low} Übergang stattgefunden, wird ein Event erzeugt.
